...
const API = "https://api.openweathermap.org/data/2.5/forecast?id=524901&appid=b633dd9c3c66d5c50f0fccd7c33cd2e7&units=metric";
...
class App extends React.Component {
  ...
  componentDidMount() {
    fetch(API).then(results => results.json()).then(data => {
      this.setState({weather: data.list.map(forecast => {
